...
# 1. Map of Mahikeng local municipality - Completed graph
graph = {
...
# 3. Heuristic to goal = Coligny (Traffic per city)
heuristic = {
    "Disaneng": 70,
    "Mahikeng": 50,
    "Mmabatho": 55,
...
# 4. Simulation Function (Fixed typos)
...
opt_path, v_order, total_c = astar(graph, weights, heuristic, start_node, goal_node)
simulate_path(opt_path, v_order, total_c)